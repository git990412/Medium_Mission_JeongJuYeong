...
public class PostService {
  ...
  @Transactional
  public void createComment(Long id, String body, Long memberId) {
    Post post = postRepository.findById(id).orElseThrow();
    post.getComments().add(commentRepository.save(
        com.ll.medium.domain.post.comment.entity.Comment.builder()
            .body(body)
            .post(post)
